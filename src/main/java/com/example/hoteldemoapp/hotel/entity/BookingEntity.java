...
import com.example.hoteldemoapp.hotel.enums.BookingStatus;
import com.example.hoteldemoapp.minibar.entity.RoomProductSale;
...
public class BookingEntity {
    ...
    @OneToMany(mappedBy = "bookingEntity", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<RoomProductSale> miniBarUsages = new ArrayList<>();
